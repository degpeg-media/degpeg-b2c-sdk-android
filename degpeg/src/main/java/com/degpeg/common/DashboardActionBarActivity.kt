...
internal abstract class DashboardActionBarActivity : BaseActivity(), View.OnClickListener {
    lateinit var actionView: LayoutHomeToolbarBinding

    override fun setContentView(view: View?) {
        if (view != null) {
            actionView = LayoutHomeToolbarBinding.bind(view)
